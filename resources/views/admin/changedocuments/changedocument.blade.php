<section>
                    ...
                    @foreach($changedocuments as $changedocument)
                        <tr> <th>{!! $changedocument->designdocument->designation !!}</th>  
                        <th>{!! $changedocument->designdocument->name !!}</th> 
                        <th>{!! $changedocument->designdocument->type !!}</th> 
                        <th>  <a href="#">{{$changedocument->number}}</a> </th> 
                        <th>  <a href="#">{{$changedocument->documentfile}}</a> </th> 
