...
<!-- Main -->
	<div id="main">
		<div class="inner">
			...
			<!-- Header -->
				<header id="header">
					<a href="index.html" class="logo"><strong>Группа компаний</strong> ИжПЗ</a>
					<ul class="icons">
			...
			<!-- Section -->
				<section>
					...
					<div class="posts">
						<article>
							<a href="#" class="image"><img src="images/ОООИжПЗ.jpg" alt="" /></a>
							<h3>ООО ИжПЗ</h3>
						...
						<article>
							<a href="#" class="image"><img src="images/ОООИжПЗСвязь.jpg" alt="" /></a>
						...
						<article>
							<a href="#" class="image"><img src="images/ОООИжПЗТест.jpg" alt="" /></a>
						...
						<article>
							<a href="#" class="image"><img src="images/ОООИжПЗМеханика.jpg" alt="" /></a>
						...
						<article>
							<a href="#" class="image"><img src="images/ОООИжПЗФотон.jpg" alt="" /></a>
						...
						<article>
							<a href="#" class="image"><img src="images/ОООИжПЗТелеком.jpg" alt="" /></a>
		...
		<div class="inner">
			...
			<!-- Section -->
				<section>
					...
					<p>Контакт-центр АО «ИжПЗ» осуществляет консультации по продукции и услугам группы компаний АО «ИжПЗ», а также обработку жалоб, отзывов и предложений.</p>
					<ul class="contact">
