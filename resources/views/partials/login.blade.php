...
<div class="h-screen dg-white flex flex-col space-y-10 justify-center items-center">
    <div class="bg-white w-96 shadow-x1 rounted p-5">
        <h1 class="text-3x1 font-medium">Вход для сотрудников ИжПЗ</h1>
        <form method="POST" action="{{route('login_process')}}"   class="col-3 offset-4">
            @csrf
            ...
            <div>
                <a  href="{{route('register') }}" class="font-medium text-blue-900 hover:dg-blue-300 rounted-md p-2"> Регистрация</a>
            </div>
